import type { MediaItem, TimelineEntry } from "@/types/content";
...
export const SERVED_SEGMENTS: string[] = [
	"Alimentação",
	"Fast-food",
	"Setor religioso",
	"Lojistas",
...
export const FRANCHISE_ABOUT_PARAGRAPHS: string[] = [
...
export const MARKET_DATA_IMAGES: MediaItem[] = [
	{
