...
/**
 * Política de Privacidade inicial, para o documento nascer completo no primeiro
 * acesso. Espelha `apps/web/src/data/privacy-policy.ts`, mas com os dados do site
 * como tokens (`{{site.name}}` etc.) — resolvidos na renderização a partir do
 * documento `site` (spec §7.3). Temporário, como os demais seeds.
 */
export const PRIVACY_POLICY_SEED: PrivacyPolicyContent = {
