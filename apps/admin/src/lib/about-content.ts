...
/**
 * Conteúdo inicial da página Sobre, para o documento nascer completo no primeiro
 * acesso. Espelha `apps/web/src/data/about.ts` (temporário, como os demais
 * seeds) — precisa ser fiel e inteiro, senão a primeira publicação encolheria a
 * história no site.
 */
